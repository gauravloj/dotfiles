    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd("LspAttach", {
        ...
        callback = function(event)
          ...
          map("gr", "<cmd>lua vim.lsp.buf.references()<CR>", "Go to references")
          -- nnoremap("<leader>ca", "<cmd>lua vim.lsp.buf.code_action()<CR>", opts)
          -- nnoremap("<leader>f", "<cmd>lua vim.diagnostic.open_float()<CR>", opts)
          map("[d", '<cmd>lua vim.diagnostic.goto_prev({ border = "rounded" })<CR>', "Go to previous diagnostic")
          map("gl", '<cmd>lua vim.diagnostic.open_float({ border = "rounded" })<CR>', "Open diagnostic float")
          map("]d", '<cmd>lua vim.diagnostic.goto_next({ border = "rounded" })<CR>', "Go to next diagnostic")
          map("<leader>q", "<cmd>lua vim.diagnostic.setloclist()<CR>", "Set location list")
